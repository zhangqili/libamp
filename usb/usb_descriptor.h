...
#ifdef MSC_ENABLE
#define MSC_EPIN_ADDR  (ENDPOINT_DIR_IN | MSC_IN_EPNUM)
#define MSC_EPOUT_ADDR  (ENDPOINT_DIR_OUT | MSC_OUT_EPNUM)
#endif
	...
	.MS_DataOutEndpoint =
		{
			...
			.EndpointAddress        = MSC_EPOUT_ADDR,
			.Attributes             = (EP_TYPE_BULK | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = MSC_EPSIZE,
			.PollingIntervalMS      = USB_POLLING_INTERVAL_MS
		}
